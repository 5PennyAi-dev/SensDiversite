    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      */}
      ...
      <div className="fixed bottom-4 right-4 z-50 opacity-0 hover:opacity-100 transition-opacity duration-500">
        <a
          href="/admin"
          className="bg-zinc-900/80 backdrop-blur-md ring-1 ring-white/10 text-xs px-3 py-1.5 rounded-full text-muted-foreground hover:text-primary transition-all shadow-xl hover:shadow-primary/20"
        >
          Admin
        </a>
      </div>
